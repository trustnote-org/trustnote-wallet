...
if [ ! -d $PROJECT ]; then
    ...
    cordova create ../../trustnotebuilds/project-$1 org.trustnote.testwallet TrustNote
    checkOK
...
if [ $CURRENT_OS == "ANDROID" ]; then
    ...
    mv $PROJECT/platforms/android/app/build/outputs/apk/debug/app-debug.apk $BUILDDIR/../../trustnotebuilds/trustnote-test.apk
    checkOK
...
if [ $CURRENT_OS == "IOS" ]; then
    ...
    echo "Done, open ${PROJECT}/platforms/ios/TrustNote-test.xcodeproj"

    open $PROJECT/platforms/ios/TrustNote-test.xcodeproj
    checkOK
