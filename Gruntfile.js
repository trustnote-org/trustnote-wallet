	...
	grunt.initConfig({
				...
				files: [
					{
						expand: true,
						cwd: './webkitbuilds/',
						src: ['trustnote.desktop', '../public/img/icons/icon-white-outline.ico', '../public/img/icons/icon-white-256.png'],
						dest: '../trustnotebuilds/TrustNote/linux32/',
						flatten: true,
						filter: 'isFile',
						options: {timestamp: true, mode: true}
					},
					{
						...
						cwd: './webkitbuilds/',
						src: ['trustnote.desktop', '../public/img/icons/icon-white-outline.ico', '../public/img/icons/icon-white-256.png'],
						dest: '../trustnotebuilds/TrustNote/linux64/',
						flatten: true,
						filter: 'isFile',
						options: {timestamp: true, mode: true}
					},
		...
		nwjs: {
			options: {
				...
				macPlist: {
					CFBundleIdentifier: 'org.trustnote.wallet',
					CFBundleURLTypes: [{
						CFBundleURLName: 'TrustNote action',
						CFBundleURLSchemes: ['trustnote']
		...
		debian_package: {
			linux64: {
				files: [
					{
						expand: true,
						cwd: '../trustnotebuilds/trustnote-test/linux64/',
						src: ['**/*'],
						dest: '/opt/trustnote-test/'
					},
